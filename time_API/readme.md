...
```python
{
    "data": {
        ...
        "email": "l@email.com",
        "password": "pass",
        "api_key": "eOIKfY_mYM6MhcV4zXXzFA",
        "time_zone": "UTC",
        "admin": 1,
        "time_entries": [
            "TIME_ENTRY(1,'None',0)",
            "TIME_ENTRY(2,'testing still',0)"
        ]
    }
}
```
...
```python
{
	"description" : "timer test" # optional
	"project_id" : None # optional
	"time_entry_id" : None # id if stoping, null if starting
}
```
**Response with no time entry id (starting):**
```python
{
    "data": {
        "id": 3,
        ...
        "running": 1,
        "start": "02/03/2022, 18:52:03",
        "stop": "02/03/2022, 18:52:03" # the stop time will be the current time as long as the timer is running
    }
}
```
**Response with time entry id (stopping):**
```python
{
    "data": {
        "id": 3,
        ...
        "task_entry_id": null,
        "description": "timer test",
        "running": 0, # note that running is now false
        "start": "02/03/2022, 18:52:03",
        "stop": "02/03/2022, 18:53:57"
    }
}
```
